...
map_to_benchmark()
{
        ...
        case $_DISTRO in
                OSX)
                        ...
                        # OSX 10.13
                        if [ `expr $_VER \>= 17.0 \& $_VER \< 18.0` -eq 1 ]
                        then
                                BENCHMARK="CIS_Apple_macOS_10.13_Benchmark_v1.1.0-xccdf.xml"
                                PROFILE1="Level 1"
                                PROFILE2="Level 2"
                                ARFORXML="-x"
                        fi
                        ...
                        # OSX 10.14
                        if [ `expr $_VER \>= 18.0 \& $_VER \< 19.0` -eq 1 ]
                        then
                                BENCHMARK="CIS_Apple_macOS_10.14_Benchmark_v1.1.0-xccdf.xml"
                                PROFILE1="Level 1"
                                PROFILE2="Level 2"
                                ARFORXML="-x"
                        fi
                        ...
                        # OSX 10.15
                        if [ `expr $_VER \>= 19.0` -eq 1 ]
                        then
                                BENCHMARK="CIS_Apple_macOS_10.15_Benchmark_v1.1.0-xccdf.xml"
                                PROFILE1="Level 1"
                                PROFILE2="Level 2"
                                ARFORXML="-x"
                        fi
                ...
                Debian)
                        ...
                        then
                                BENCHMARK="CIS_Debian_Linux_8_Benchmark_v2.0.1-xccdf.xml"
				...
				PROFILE2="Level 2 - Server"
                        ...
                        then
                                BENCHMARK="CIS_Ubuntu_Linux_18.04_LTS_Benchmark_v2.0.1-xccdf.xml"
                                PROFILE1="Level 1 - Server"
                                PROFILE2="Level 2 - Server"
                        fi
                        ...
                        then
                                BENCHMARK="CIS_Ubuntu_Linux_20.04_LTS_Benchmark_v1.0.0-xccdf.xml"
                                PROFILE1="Level 1 - Server"
                                PROFILE2="Level 2 - Server"
                        fi
			...
			;;
                RedHat)
                        ...
                        then
                                BENCHMARK="CIS_Red_Hat_Enterprise_Linux_7_Benchmark_v3.0.1-xccdf.xml"
                                PROFILE1="Level 1 - ${ROLE}"
                                PROFILE2="Level 2 - ${ROLE}"
                        fi
                        ...
                        then
                                BENCHMARK="CIS_Red_Hat_Enterprise_Linux_8_Benchmark_v1.0.0.1-xccdf.xml"
                                PROFILE1="Level 1 - ${ROLE}"
                                PROFILE2="Level 2 - ${ROLE}"
                        fi
                ...
                Oracle)
                        ...
                        if [ `expr $_VER \>= 6.0 \& $_VER \< 7.0` -eq 1 ]
                        then
                                BENCHMARK="CIS_Oracle_Linux_6_Benchmark_v1.0.0-xccdf.xml"
                                PROFILE1="Level 1 - ${ROLE}"
                                PROFILE2="Level 2 - ${ROLE}"
                        fi
                        ...
                        if [ `expr $_VER \>= 7.0 \& $_VER \< 8.0` -eq 1 ]
                        then
                                BENCHMARK="CIS_Oracle_Linux_7_Benchmark_v3.0.0-xccdf.xml"
                                PROFILE1="Level 1 - ${ROLE}"
                                PROFILE2="Level 2 - ${ROLE}"
                        fi
                        ...
                        if [ `expr $_VER \>= 8.0 \& $_VER \< 9.0` -eq 1 ]
                        then
                                BENCHMARK="CIS_Oracle_Linux_8_Benchmark_v1.0.0.1-xccdf.xml"
                                PROFILE1="Level 1 - ${ROLE}"
                                PROFILE2="Level 2 - ${ROLE}"
                        fi
			...
			if [ `expr $_VER \>= 7.0 \& $_VER \< 8.0` -eq 1 ]
			then
				BENCHMARK="CIS_CentOS_Linux_7_Benchmark_v3.0.0-xccdf.xml"
				PROFILE1="Level 1 - ${ROLE}"
				PROFILE2="Level 2 - ${ROLE}"
			fi
                        ...
                        if [ `expr $_VER \>= 8.0 \& $_VER \< 9.0` -eq 1 ]
                        then
                                BENCHMARK="CIS_CentOS_Linux_8_Benchmark_v1.0.0.1-xccdf.xml"
                                PROFILE1="Level 1 - ${ROLE}"
                                PROFILE2="Level 2 - ${ROLE}"
                        fi
                ...
                SUSE)
                        ...
                        if [ `expr $_VER \>= 15.0 \& $_VER \< 16.0` -eq 1 ]
                        then
                                BENCHMARK="CIS_SUSE_Linux_Enterprise_15_Benchmark_v1.0.0-xccdf.xml"
